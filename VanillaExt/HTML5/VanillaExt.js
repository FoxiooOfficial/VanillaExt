/*
	This VanillaExt Fusion extension HTML5 port is under MIT license.
...
//
CRunVanillaExt.prototype = CServices.extend(new CRunExtension(), {
	...
	condition: function(num, cnd) {
		...
		if (func == null) {
			throw "Unrecognised condition ID " + (~~num) + " passed to VanillaExt.";
		}
	...
	action: function(num, act) {
		...
		if (func == null) {
			throw "Unrecognised action ID " + (~~num) + " passed to VanillaExt.";
		}
	...
	expression: function(num) {
		...
		if (func == null) {
			throw "Unrecognised expression ID " + (~~num) + " passed to VanillaExt.";
		}
